...
module.exports = function(config) {
    var bus = config.bus;
    var ussdConfig = _.defaults(bus.config.ussd || {}, {
        shortcodes: {},
        phoneNumber: '1234',
        defaultCode: '*131#'
    });
    ...
    var ussd = {
        ...
        route: function(data) {
            var state;
            if (ussdConfig.shortCodes[data.system.message]) {
        ...
        receive: function(data) {
            ...
            tasks.push(function(params) {
                ...
                if (params.system.resume) {
                    ...
                    if (!redirect && ussdConfig.resumeState) {
                        params.system.routes = {'resume': ussdConfig.resumeState};
